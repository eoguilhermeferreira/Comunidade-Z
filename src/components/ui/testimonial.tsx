            ...
            return (
              <motion.div
                ...
                className={cn(
                  ...
                  "border border-slate-700/40 bg-slate-800/60 shadow-xl backdrop-blur-sm",
                )}
                style={{
              ...
              >
                {showArrows && isCurrentCard && (
                  <div className="absolute inset-x-0 top-2 flex justify-between px-4">
                    <span className="cursor-pointer select-none text-2xl text-white/30 transition-colors hover:text-white/60">
                      &larr;
                    </span>
                    <span className="cursor-pointer select-none text-2xl text-white/30 transition-colors hover:text-white/60">
                      &rarr;
